...
const MovieRecommendation = () => {
  ...
  const handleMovieClick = (movie) => {
    setSelectedMovie(movie); // Open modal with selected movie details
  };
  ...
  return (
    <div className="relative">
      <div className={`container mx-auto p-4 ${selectedMovie ? 'blur-md' : ''}`}>
      ...
      {selectedMovie && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-11/12 max-w-2xl relative flex">
            <button
              className="text-gray-600 absolute top-4 right-4 text-xl"
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-800 mb-2"><strong>Release Date:</strong> {selectedMovie.release_date}</p>
              <p className="text-gray-800 mb-2"><strong>Rating:</strong> {selectedMovie.vote_average}</p>
              <p className="text-gray-800 mb-2"><strong>Overview:</strong> {selectedMovie.overview}</p>
